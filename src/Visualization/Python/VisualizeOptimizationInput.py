<<<<<<<< HEAD:src/Visualization/Python/VisualizeOptimizationInput.py
...
# Line folding
try:
    plotter.PlotLinefoldingConstraintEdges(datadir, 7)
except: 
...
#-------------
plotter.ShowFigures()
>>>>>>>> develop/grid-generator-main:src/Visualization/Python/root/VisualizeGDInput.py
