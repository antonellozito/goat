...
specification = root.find('module[@name="goat.parameters"]/routine[@name="goatcdcn"]')
...
fort = DELIMITER
fort += """* Generated by goatcdcn.py from goatinput.xml. DO NOT EDIT THIS FILE!
*.specification
...
goat_parameters = root.find('module[@name="goat.parameters"]')
categories = goat_parameters.findall('category')
...
fort += DELIMITER
fort += """*.end goatcdcn\n\n      end subroutine goatcdcn\n"""

if sys.version_info[0] >= 3:
    f = open('goatcdcn.F', 'wb')
    f.write(fort.encode())
else:
    f = open('goatcdcn.F', 'w')
